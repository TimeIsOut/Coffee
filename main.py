import sys, sqlite3
import Ui_AddEdit from addEditCoffeeForm
import Ui_Coffee from ui
from PyQt5 import uic, QtCore, QtGui, QtWidgets


class AddEdit(QtWidgets.QMainWindow, Ui_AddEdit):
...
class Coffee(QtWidgets.QMainWindow, Ui_Coffee):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.f1 = AddEdit(1)
        self.f2 = AddEdit(2)
        self.base = sqlite3.connect("Data\coffee.sqlite")
